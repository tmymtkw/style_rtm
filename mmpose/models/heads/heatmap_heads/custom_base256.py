...
class CustomBaseHead256(BaseHead):
    def __init__(self,
                 ...
                 u2net_weight: str = "/home/matsukawa_3/U-2-Net/saved_models/u2netp/u2netp.pth",
                 ratio = 0.5):
        ...
        self.conv0 = ConvBlock(17, 256, 1, 1, 0, 1)
        # second layer
        self.conv1 = ConvBlock(256,256,3,2,1, 256)
        self.conv2 = ConvBlock(256,256,3,2,1, 256)
        self.conv3 = ConvBlock(256,256,3,2,1, 256)
        self.deconv3 = DeconvBlock(256,256,2,2,0, 256)
        self.deconv2 = DeconvBlock(256,256,2,2,0, 256)
        self.deconv1 = DeconvBlock(256,256,2,2,0, 256)

        self.final = ConvBlock(256, 17, 1, 1, 0, 1)
