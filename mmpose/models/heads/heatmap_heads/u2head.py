...
class U2Head(BaseHead):
    ...
    def forward(self, feats: tuple) -> Tuple[Tensor, Tensor]:
    ...
    def predict(self,
        ...
        if test_cfg.get('flip_test', False):
            ...
            _batch_heatmaps, __ = self.forward(_feats)
            _batch_heatmaps_flip, __ = self.forward(_feats_flip)
            ...
            batch_heatmaps, __ = self.forward(feats)
    ...
    def loss(self,
        ...
        """
        pred_fields, pred_sub = self.forward(feats)
        ...
        loss_sub = self.loss_module(pred_sub, gt_heatmaps, keypoint_weights)

        losses.update(loss_kpt=loss_kpt, loss_sub=loss_sub)
