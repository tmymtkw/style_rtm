...
from ..heads.heatmap_heads.custom_heads import U2NETP
...
class VisionTransformerU2(BaseBackbone):
    """Vision Transformer.
    ...
    def __init__(self,
                 ...
                 pre_norm=False,
                 return_input=False,
                 u2net_weight="/home/matsukawa_3/U-2-Net/saved_models/u2netp/u2netp.pth",
                 init_cfg=None):
        super(VisionTransformerU2, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(VisionTransformerU2, self).init_weights()
    ...
    def forward(self, _x):
        ...
        #print(_x.shape)
        B = _x.shape[0]
        x, patch_resolution = self.patch_embed(_x)
