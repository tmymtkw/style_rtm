...
class UViT9(BaseBackbone):
    def __init__(self,
        ...
        self.up_linear = nn.Sequential(
            nn.Linear(emb_dims[1], emb_dims[0]),
        ...
        for _ in range(num_attn):
            self.cat_attn.append(DecoderBlock(emb_dims[0], heads[0], hidden_dims[0], drop_rate))
