...
# runtime
train_cfg = dict(max_epochs=210, val_interval=30)
...
data_root = '/home/matsukawa/datasets_augmented/kmeans/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='HumanArt/annotations/validation_humanart_cartoon.json',
        bbox_file=f'{data_root}HumanArt/person_detection_results/'
...
test_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'HumanArt/annotations/validation_humanart_cartoon.json')
